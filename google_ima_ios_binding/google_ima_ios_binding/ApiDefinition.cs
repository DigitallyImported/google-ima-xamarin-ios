...
namespace GoogleIma
{
	...
	interface IMAVideoDisplayDelegate
	{
		...
		// @required -(void)onPlay __attribute__((deprecated("")));
		[Abstract]
		[Export("onPlay")]
		void OnPlay();

		// @required -(void)onVolumeChangedToVolume:(float)volume __attribute__((deprecated("")));
		[Abstract]
		[Export("onVolumeChangedToVolume:")]
		void OnVolumeChangedToVolume(float volume);

		// @required -(void)onProgressWithMediaTime:(NSTimeInterval)mediaTime totalTime:(NSTimeInterval)totalTime __attribute__((deprecated("")));
		[Abstract]
		[Export("onProgressWithMediaTime:totalTime:")]
		void OnProgressWithMediaTime(double mediaTime, double totalTime);

		// @required -(void)onClick __attribute__((deprecated("")));
		[Abstract]
		[Export("onClick")]
		void OnClick();

		// @required -(void)onPause __attribute__((deprecated("")));
		[Abstract]
		[Export("onPause")]
		void OnPause();

		// @required -(void)onResume __attribute__((deprecated("")));
		[Abstract]
		[Export("onResume")]
		void OnResume();

		// @required -(void)onComplete __attribute__((deprecated("")));
		[Abstract]
		[Export("onComplete")]
		void OnComplete();

		// @required -(void)onError __attribute__((deprecated("")));
		[Abstract]
		[Export("onError")]
		void OnError();

		// @required -(void)onSkip __attribute__((deprecated("")));
		[Abstract]
		[Export("onSkip")]
		void OnSkip();

		// @required -(void)onSkipShown __attribute__((deprecated("")));
		[Abstract]
		[Export("onSkipShown")]
		void OnSkipShown();

		// @required -(void)onStart __attribute__((deprecated("")));
		[Abstract]
		[Export("onStart")]
		void OnStart();

		// @required -(void)onTimedMetadata:(NSDictionary *)metadata __attribute__((deprecated("")));
		[Abstract]
		[Export("onTimedMetadata:")]
		void OnTimedMetadata(NSDictionary metadata);

		// @required -(void)onLoaded __attribute__((deprecated("")));
		[Abstract]
		[Export("onLoaded")]
		void OnLoaded();
		...
		// @optional -(void)onBufferedWithMediaTime:(NSTimeInterval)mediaTime __attribute__((deprecated("")));
		[Export("onBufferedWithMediaTime:")]
		void OnBufferedWithMediaTime(double mediaTime);

		// @optional -(void)onPlaybackReady __attribute__((deprecated("")));
		[Export("onPlaybackReady")]
		void OnPlaybackReady();

		// @optional -(void)onStartBuffering __attribute__((deprecated("")));
	...
	interface IMAAdsManagerDelegate
	{
		...
		void AdsManagerReceivedEvent(IMAAdsManager adsManager, IMAAdEvent @event);

		// @required -(void)adsManager:(IMAAdsManager *)adsManager didReceiveAdError:(IMAAdError *)error;
		[Abstract]
		[Export("adsManager:didReceiveAdError:")]
		void AdsManagerReceivedError(IMAAdsManager adsManager, IMAAdError error);
		...
		void AdsManagerUpdateTime(IMAAdsManager adsManager, double mediaTime, double totalTime);
	...
	interface IMAAdsRequest
	{
		...
		IntPtr Constructor(string adTagUrl, IMAAdDisplayContainer adDisplayContainer, IMAAVPlayerVideoDisplay avPlayerVideoDisplay, [NullAllowed] IMAPictureInPictureProxy pictureInPictureProxy, [NullAllowed] NSObject userContext);
		...
		[DesignatedInitializer]
		IntPtr Constructor(string adTagUrl, IMAAdDisplayContainer adDisplayContainer, [NullAllowed] IMAAVPlayerContentPlayhead contentPlayhead, [NullAllowed] NSObject userContext);

		// -(instancetype)initWithAdTagUrl:(NSString *)adTagUrl adDisplayContainer:(IMAAdDisplayContainer *)adDisplayContainer contentPlayhead:(NSObject<IMAContentPlayhead> *)contentPlayhead userContext:(id)userContext __attribute__((objc_designated_initializer));
		[Export("initWithAdsResponse:adDisplayContainer:contentPlayhead:userContext:")]
		IntPtr Constructor(NSString adsResponse, IMAAdDisplayContainer adDisplayContainer, [NullAllowed] IMAAVPlayerContentPlayhead contentPlayhead, [NullAllowed] NSObject userContext);
	}
